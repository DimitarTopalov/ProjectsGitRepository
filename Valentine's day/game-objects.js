...
export const factory = {
  createWizzard(wizardConfig) {
    ...
    wizardElement.style.backgroundImage = 'url("images/racoon4.png")';
  ...
  createFireball(wizardConfig) {
    ...
    fireballElement.style.backgroundImage = 'url("images/heart.png")';
  ...
  createBug() {
    ...
    // Set styles
    bugElement.style.width = "45px";
    bugElement.style.height = "45px";
    bugElement.style.backgroundImage = 'url("images/bat.png")';
